  ...
  if (isReviewerRoute) {
    return (
      <div className="relative min-h-screen overflow-x-clip bg-bg1 text-foreground">
        <main className="relative z-10 mx-auto flex min-h-screen max-w-4xl flex-col justify-center gap-6 border-x border-border-low px-6 py-16">
          <p className="text-sm uppercase tracking-[0.18em] text-muted">
            Reviewer Console
          </p>
          <section className="w-full max-w-2xl space-y-3 rounded-2xl border border-border-low bg-card p-6 shadow-[0_20px_80px_-50px_rgba(0,0,0,0.35)]">
            <h1 className="text-3xl font-semibold tracking-tight text-foreground">
              Reviewer access required
            </h1>
            <p className="text-base leading-relaxed text-muted">
              This route is restricted to authenticated internal reviewers during
              the off-chain MVP.
            </p>
            <a
              className="inline-flex items-center rounded-lg border border-border-low bg-cream px-3 py-2 text-sm font-medium transition hover:-translate-y-0.5 hover:shadow-sm"
              href="/"
            >
